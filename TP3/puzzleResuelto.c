...
int turno = 0; // CODIGO IMPLENENTADO
void *comer_hamburguesa(void *tid)
{
    while (1 == 1)
    {
        
        while (turno != (int)tid) // CODIGO IMPLEMENTADO
            ; 
        ...
        if (cantidad_restante_hamburguesas > 0)
        {
            ...
            cantidad_restante_hamburguesas--; // yo como una hamburguesa
        ...
        else
        {
            ...
            pthread_exit(NULL); // para la terminacion del hilo
        }
        turno = (turno + 1) % NUMBER_OF_THREADS; // CODIGO IMPLEMENTADO
